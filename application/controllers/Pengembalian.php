...
class Pengembalian extends CI_Controller{
    ...
    public function insert_submit(){
        ...
        if($this->input->post('submit') == 'Simpan'){
            ...
            $this->form_validation->set_rules('jumlah_pengembalian', 'Jumlah Pengembalian','required');
            $this->form_validation->set_rules('denda_telat', 'Denda Rusak','required');
            $this->form_validation->set_rules('denda_hilang', 'Denda Hilang','required');
            $this->form_validation->set_rules('denda_rusak', 'Denda Rusak','required');
